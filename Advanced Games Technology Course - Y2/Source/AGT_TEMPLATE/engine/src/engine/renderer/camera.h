...
namespace engine
{
    ...
    public:
        ...
        { 
            ...
            left, 
            right,
            up,//This was used to edit the game 
            down //this was used to edit the game
        };
    ...
    public: 
        ...
        glm::vec3 position() const override { return m_position; }
        void set_position(const glm::vec3& pos) { m_position = pos; update_view_matrix(); }
        void position(const glm::vec3& pos) override { m_position = pos; update_view_matrix(); }
        ...
        void set_view_matrix_up(glm::vec3 position, glm::vec3 look_at, glm::vec3 upVec);
