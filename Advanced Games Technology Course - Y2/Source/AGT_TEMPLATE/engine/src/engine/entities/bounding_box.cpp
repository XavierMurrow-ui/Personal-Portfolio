...
void engine::bounding_box::on_render(float t, /*float r, float g, float b,*/ const engine::ref<engine::shader>& shader)
{
	...
	std::dynamic_pointer_cast<engine::gl_shader>(shader)->set_uniform("transparency", t);
